            ...
            <div class="box box-info">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <textarea name="role_description" class="form-control" cols="30" rows="4" id="role_description"></textarea>
                    ...
                    <div class="permission-list">
                        <ul>
                            <?php foreach ($this->Role_model->get_permissions()->group_by('display_name')->get()->result() as $perm): ?>
                                <li>
                                    ...
                                    <ul>
                                        <?php foreach ($this->Role_model->get_permissions()->where('display_name', $perm->display_name)->get()->result() as $permission): ?>
                                            <li>
                                                <label><input type="checkbox" class="child minimal" name="permissions[]" value="<?= $perm->id ?>">
